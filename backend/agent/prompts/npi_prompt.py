...
{{ "npi_valid": true/false (based on NPI format and active status), "npi_status": "active" or "inactive" or "not_found", "provider_name": "Full Name", "provider_specialty": "Primary specialty description", "specialty_match": true/false (Is this specialty appropriate for this procedure?), "specialty_match_reasoning": "2-3 sentence logic explaining matching/mismatch" }}"""
